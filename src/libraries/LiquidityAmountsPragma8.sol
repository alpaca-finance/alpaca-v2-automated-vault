...
import "./FullMathPragma8.sol";
import "./FixedPoint96Pragma8.sol";

/// @title Liquidity amount functions
/// @notice Provides functions for computing liquidity amounts from token amounts and prices
library LiquidityAmountsPragma8 {
  ...
  function getLiquidityForAmount0(
    ...
    uint256 intermediate =
      FullMathPragma8.mulDiv(sqrtRatioAX96, sqrtRatioBX96, FixedPoint96.Q96);
    return toUint128(
      FullMathPragma8.mulDiv(
